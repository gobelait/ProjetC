...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/projetc.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/projetc.exe: ${OBJECTFILES}
...
${OBJECTDIR}/_ext/5c0/ArbreAbstrait.o: ../ArbreAbstrait.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/ArbreAbstrait.o ../ArbreAbstrait.cpp

${OBJECTDIR}/_ext/5c0/Interpreteur.o: ../Interpreteur.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/Interpreteur.o ../Interpreteur.cpp

${OBJECTDIR}/_ext/5c0/Lecteur.o: ../Lecteur.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/Lecteur.o ../Lecteur.cpp

${OBJECTDIR}/_ext/5c0/Symbole.o: ../Symbole.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/Symbole.o ../Symbole.cpp

${OBJECTDIR}/_ext/5c0/SymboleValue.o: ../SymboleValue.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/SymboleValue.o ../SymboleValue.cpp

${OBJECTDIR}/_ext/5c0/TableSymboles.o: ../TableSymboles.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/TableSymboles.o ../TableSymboles.cpp
