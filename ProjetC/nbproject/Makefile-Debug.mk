...
${OBJECTDIR}/_ext/5c0/ArbreAbstrait.o: ../ArbreAbstrait.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/ArbreAbstrait.o ../ArbreAbstrait.cpp

${OBJECTDIR}/_ext/5c0/Interpreteur.o: ../Interpreteur.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/Interpreteur.o ../Interpreteur.cpp

${OBJECTDIR}/_ext/5c0/Lecteur.o: ../Lecteur.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/Lecteur.o ../Lecteur.cpp

${OBJECTDIR}/_ext/5c0/Symbole.o: ../Symbole.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/Symbole.o ../Symbole.cpp

${OBJECTDIR}/_ext/5c0/SymboleValue.o: ../SymboleValue.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/SymboleValue.o ../SymboleValue.cpp

${OBJECTDIR}/_ext/5c0/TableSymboles.o: ../TableSymboles.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/TableSymboles.o ../TableSymboles.cpp
